  ...
  return (
    <group>
      <RigidBody 
        ...
        friction={2.0} 
        frictionCombineRule={CoefficientCombineRule.Max} // Garantiza que la moto frene al máximo al tocar esta zona
      >
        <mesh receiveShadow>
...
const Ramp = React.memo(({ angle }: { angle: number }) => {
  ...
  return (
    <RigidBody 
      ...
      position={[-3, 2, 0]}
      friction={0}
      frictionCombineRule={CoefficientCombineRule.Min} // Rampa perfecta sin fricción para no arruinar la física
      restitution={0}
    >
      <mesh receiveShadow>
